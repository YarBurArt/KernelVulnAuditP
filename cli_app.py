...
class CLIApp:
    ...
    def run_report(self) -> None:
        ...
        print(renderer.build_full_report() + "\nReport generated (CLI mode)")
    ...
    def _print_feeds(self, feeds: dict[str, Any]):
        ...
        for f in findings:
            ...
            print(f"  [{src}] {cve_id} [{sev}] CVSS:{cvss}: {desc}")
    ...
    def _print_sandbox_run(cve_id: str, run: dict[str, Any]):
        ...
        print(
            f"\n  [{severity}] {cve_id} [{platform}] exit:{exit_code} "
